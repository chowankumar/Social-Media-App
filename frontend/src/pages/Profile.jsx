...
const Profile = () => {
  ...
  const isFollowing = relationshipData && Array.isArray(relationshipData) && relationshipData.some(rel => rel.followerUserId === currentUser.id);

  const defaultCoverPic = 'https://tse4.mm.bing.net/th?id=OIP.KtahHX0mDy-mEQO16gKJdAAAAA&pid=Api&P=0&h=220';
  const defaultProfilePic = "/th.jpeg";
